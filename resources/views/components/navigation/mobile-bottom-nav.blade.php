        ...
        @auth
            @if(auth()->user()->isSalonOwner())
                <a
                    ...
                    @class([
                        'mobile-bottom-item',
                        'is-active' => request()->routeIs('salon.dashboard'),
                    ])
                    aria-label="داشبورد"
                >
                    <span class="mobile-bottom-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24">
                            <path d="M4 13h6V4H4zM14 20h6v-7h-6zM14 10h6V4h-6zM4 20h6v-3H4z"/>
                        </svg>
                    </span>
                ...
                <a
                    ...
                    @class([
                        'mobile-bottom-item',
                        'is-active' => request()->routeIs('salon.bookings.*'),
                    ])
                    aria-label="نوبت‌ها"
                >
                    <span class="mobile-bottom-icon" aria-hidden="true">
                ...
                <a
                    ...
                    @class([
                        'mobile-bottom-item',
                        'is-active' => request()->routeIs('salon.notifications.*'),
                    ])
                    aria-label="اعلان‌ها"
                >
                    <span class="mobile-bottom-icon" aria-hidden="true">
                ...
                <a
                    ...
                    @class([
                        'mobile-bottom-item',
                        'is-active' => request()->routeIs('salon.settings.*'),
                    ])
                    aria-label="تنظیمات"
                >
                    <span class="mobile-bottom-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24">
                            ...
                            <path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-1.7 1.7-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.1h-2.4v-.1a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1-1.7-1.7.1-.1a1.7 1.7 0 0 0 .3-1.9 1.7 1.7 0 0 0-1.6-1H6.6v-2.4h.2a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L8 7.6 9.7 5.9l.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.6v-.1h2.4v.1a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1 1.7 1.7-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.1V13h-.1a1.7 1.7 0 0 0-1.6 1Z"/>
                        </svg>
                    </span>
            ...
            @else
                ...
                @else
                    <a href="{{ route('brand.intro') }}" class="mobile-bottom-item" aria-label="حساب">
                        <span class="mobile-bottom-icon" aria-hidden="true">
