    ...
    <header class="customer-header">
        <div class="customer-container">
            <div class="customer-header-inner">
                <a href="{{ route('brand.intro') }}" class="customer-brand" aria-label="RM نوبت‌دهی">
                    <span class="customer-brand-mark">RM</span>
                    <span class="customer-brand-copy">
                        <span class="customer-brand-name">نوبت‌دهی</span>
                        <span class="customer-brand-caption">پیدا کن. انتخاب کن. نوبت بگیر.</span>
                    </span>
                </a>

                <nav class="customer-nav" aria-label="ناوبری اصلی">
                    <a href="{{ route('brand.intro') }}" @class(['customer-nav-link', 'is-active' => request()->routeIs('brand.intro')])>خانه</a>
                    ...
                    <a href="{{ route('salons.discover', ['type' => 'barber']) }}" @class(['customer-nav-link', 'is-active' => request()->query('type') === 'barber'])>آرایشگرها</a>
                    @auth
